...
public class LoginFrame extends BaseFrame {
    ...
    private void addTitle() {
        JLabel titleLabel = new JLabel(I18n.getTranslation("login_welcome"));
    ...
    private void addSubtitle() {
        JLabel subtitle = new JLabel("<html><div>" + I18n.getTranslation("login_subtitle") + "</div></html>");
    ...
    private void addEmailField() {
        JLabel emailLabel = new JLabel(I18n.getTranslation("login_email"));
        ...
        emailField.setPlaceholder(I18n.getTranslation("login_email"));
    ...
    private void addPasswordField() {
        JLabel passLabel = new JLabel(I18n.getTranslation("login_password"));
        ...
        passwordField.setPlaceholder(I18n.getTranslation("login_password"));
    ...
    private void addLoginButton() {
        loginButton = new RoundedButton(I18n.getTranslation("login_login"), 20);
    ...
    private void addRegisterLink() {
        registerLabel = new JLabel("<html>" + I18n.getTranslation("login_register") + "</html>");
