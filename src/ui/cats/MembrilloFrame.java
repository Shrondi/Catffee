...
public class MembrilloFrame extends JFrame {

    public MembrilloFrame() {
        setTitle("Perfil de Membrillo");
        setSize(412, 917);
        ...
        background.add(buildInfoPanel("MEMBRILLO", "6 años", "Macho", "Mimoso y melancólico. Membrillo parece un poeta en forma de gato. Le encanta tumbarse a mirar el vacío.", "Alguien sensible y con ganas de un amigo tranquilo."));
    }
